...
export function SearchResultCard({
  ...
  return (
    <>
      <article
        tabIndex={0}
        className="group flex h-full flex-col rounded-xl border border-border bg-surface shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus-within:ring-2 focus-within:ring-primary/40 focus:outline-none"
      >
